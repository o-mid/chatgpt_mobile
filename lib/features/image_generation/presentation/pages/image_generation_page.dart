...
import 'package:chatgpt_mobile/features/global/search_text_field/search_text_field_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Column(
          children: [
            Expanded(child: BlocBuilder<ImageGenerationCubit, ImageGenerationState>(
              builder: (context, imageGenerationState) {
                if (imageGenerationState is ImageGenerationLoading) {
                  return Center(
                    child: Container(
                        width: 300, height: 300, child: Image.asset("assets/loading.gif")),
                  );
                }
                ...
                if (imageGenerationState is ImageGenerationLoaded) {
                  return MasonryGridView.builder(
                      ...
                      mainAxisSpacing: 3,
                      crossAxisSpacing: 3,
                      itemCount: imageGenerationState.imageGenerationModelData.data.length,
